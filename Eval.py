...
# Basic options
parser.add_argument('--content', type=str, default = 'input/content/10_stylized_9.jpg',
                    help='File path to the content image')
parser.add_argument('--style', type=str, default = 'input/content/10.jpg',
...
parser.add_argument('--output', type=str, default = '2nd_train_output/sball12/',
