...
# Basic options
parser.add_argument('--content_dir', type=str, default='/home/ma4/2D_trans/IEContraAST/data/train2014/',
                    help='Directory path to a batch of content images')
parser.add_argument('--style_dir', type=str, default='/home/ma4/2D_trans/IEContraAST/NEW_DATA/sim_data5000/',
                    help='Directory path to a batch of style images')
parser.add_argument('--vgg', type=str, default='model/vgg_normalised.pth')
parser.add_argument('--sample_path', type=str, default='samples_round5', help='Derectory to save the intermediate samples')
...
parser.add_argument('--restore_weight', type=float, default=0.5)
...
for i in tqdm(range(args.start_iter, args.max_iter)):
    ...
    img, loss_c, loss_s, l_identity1, l_identity2, loss_contrastive_c, loss_contrastive_s, loss_c_r = network(content_images, style_images, args.batch_size)
    ...
    # train generator
    loss_c_r = args.restore_weight * loss_c_r
    ...
    loss = loss_c_r + loss_c + loss_s + l_identity1 * 50 + l_identity2 * 1 + loss_contrastive_c + loss_contrastive_s + loss_gan_g

    optimizer.zero_grad()
    loss.backward()
    optimizer.step()

    writer.add_scalar('loss_restore', loss_c_r.item(), i + 1)
